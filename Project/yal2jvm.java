...
if (jjtc000) {
  ...
  static final public void FunctionReturn(Token id) throws ParseException {/*@bgen(jjtree) Element */
...
//Stmt ::= While | If | Assign | Call <PVIRG>
  static final public void Stmt() throws ParseException {errorIn = "CALL()";
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case WHILE:{
      While();
      break;
...
if (jjtc000) {
  ...
  static void skip_to(int t) throws ParseException {Token nextToken;
    do {
  ...
  static private boolean jj_3R_7()
 {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x8000000,0x800000,0x100,0x84000100,0x8000,0x8000000,0x8000000,0x80028000,0x80000000,0x80000,0x80000000,0x8003000,0x3000,0x8000000,0x700,0x700,0x8c000100,0xc000000,0x100,0x4000000,0x8000000,0x4000,0x0,0x4c000000,0x80000,0x4c000000,0x0,0x80000000,0xc000000,};
   }
